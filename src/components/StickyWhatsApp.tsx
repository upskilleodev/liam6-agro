...
export function StickyWhatsApp() {
  return (
    <div
      className="fixed z-[90] bottom-[max(1rem,env(safe-area-inset-bottom))] right-[max(1rem,env(safe-area-inset-right))] lg:hidden"
    >
      <WhatsAppLink
        message={whatsappMessages.contact}
        ariaLabel="Chat on WhatsApp"
        className="flex items-center justify-center w-14 h-14 rounded-full bg-[#25D366] text-white shadow-lg shadow-black/25 hover:bg-[#20bd5a] active:scale-95 transition-all touch-manipulation"
      >
